...
import { IndefinableRecordValues } from "../../types/typeUtils";
...
type ActionDialogProps = {
  ...
  dialogProps?: IndefinableRecordValues<DialogProps>;
};
...
const ActionDialog = ({ title, children, openButton, actionButton, cancelButton, dialogProps }: ActionDialogProps) => {
  ...
  return (
    <>
      {openButton(setOpen)}
      <Dialog {...(dialogProps as DialogProps)} open={open} onClose={() => setOpen(false)}>
